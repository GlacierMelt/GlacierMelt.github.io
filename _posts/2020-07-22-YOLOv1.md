...
<div align='center'><font size="4" color="#F39C12">          If the center of an object falls into a grid cell, that grid cell is responsible for detecting that object.</font></div>
